          ...
          <div className="max-w-2xl mx-auto p-4 space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                {/* Banner */}
                <div 
                  className="relative h-48 bg-gradient-to-r from-purple-600/40 to-pink-600/40 rounded-2xl overflow-hidden group cursor-pointer"
                  ...
                  {previewUrls.banner ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="text-center p-4 bg-black/20 rounded-lg backdrop-blur-sm">
                        ...
                        <p className="text-white/70 text-xs mt-1">1500x500px recommended</p>
                      </div>
                    </div>
                  )}
                  
                  <div className="absolute inset-0 flex items-center justify-center bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="bg-white/20 hover:bg-white/30 text-white backdrop-blur-sm px-4 py-2 rounded-lg">
                      {uploadingBanner ? (
                        <Loader2 className="w-4 h-4 mr-2 animate-spin inline" />
                      ) : (
                        <Upload className="w-4 h-4 mr-2 inline" />
                      )}
                      {previewUrls.banner ? 'Change' : 'Upload'} Banner
                    </div>
                  </div>
                ...
                <div className="absolute -bottom-8 left-6">
                  <div 
                    className="relative w-20 h-20 rounded-2xl bg-black/50 backdrop-blur-md border-2 border-white/20 overflow-hidden group cursor-pointer"
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                  ...
                  <div className="space-y-3">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:ring-2 focus:ring-green-500/50 focus:border-transparent transition-all"
                      onKeyPress={(e) => {
                        if (e.key === 'Enter') {
                          e.preventDefault();
                    ...
                    {formData.skills.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        {formData.skills.map((skill) => (
                          <div
                            key={skill}
                            className="flex items-center gap-1 bg-green-600/20 text-green-300 border border-green-500/30 px-3 py-1 rounded-full text-sm"
                          >
                            <span>{skill}</span>
                            <button
                              type="button"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all"
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        className="w-4 h-4 text-purple-500 rounded focus:ring-purple-500 bg-white/5 border-white/20"
                      />
                      <div>
                        <label htmlFor="nsfw" className="text-sm font-medium text-gray-300">
                          Show NSFW content
                        </label>
                        <p className="text-xs text-gray-500 mt-1">
