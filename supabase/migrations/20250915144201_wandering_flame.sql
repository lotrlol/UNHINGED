/*
  ...
  1. New Tables
    - `comments`
      ...
      - `mentioned_users` (text array, usernames mentioned)
...
-- Function to handle comment mentions
...
BEGIN
  ...
  FOREACH mentioned_username IN ARRAY NEW.mentioned_users
  LOOP
    ...
    -- If user exists, create mention record and notification
    IF mentioned_user_id IS NOT NULL THEN
      ...
      INSERT INTO notifications (
        ...
        commenter_profile.full_name || ' mentioned you in a comment',
        jsonb_build_object(
          'comment_id', NEW.id,
